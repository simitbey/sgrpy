...
def angle(ab, bc, ca):
    ...
    bc_sq = bc ** 2
    ca_sq = ca ** 2
    return math.acos((ab_sq + bc_sq - ca_sq) / (2 * ab * bc))
...
def circumference(*args):
    if len(args) == 1:
        ...
        raise ValueError("Invalid number of arguments for circumference")
